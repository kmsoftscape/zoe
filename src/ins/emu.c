...
int femuServer(void)
{
	...
	while(1)
	{
		...
		*/
		...
		if(vemuMark=='-')
		{
			printf("\033[0;31m服务端接收报文[%4d][%s]\033[0;37m\n",vemuSize,vemuFmlData);
		}
		else
		if(vemuMark=='+')
		{
			fpkgHexEnc(&vemuFmlData,&vemuTmpData,&vemuSize,"upper");
			printf("\033[0;31m服务端接收报文[%4d][%s]\033[0;37m\n",vemuSize/=2,vemuFmlData);
		...
		if(vemuMark=='-')
		{
			printf("\033[0;33m服务端发送报文[%4d][%s]\033[0;37m\n",vemuSize,vemuFmlData);
		}
		else
		if(vemuMark=='+')
		{
...
int femuClient(void)
{
	...
	*/
	...
	if(vemuMark=='-')
	{
		printf("\033[0;32m客户端发送报文[%4d][%s]\033[0;37m\n",vemuSize,vemuFmlData);
	}
	else
	if(vemuMark=='+')
	{
		fpkgHexEnc(&vemuFmlData,&vemuTmpData,&vemuSize,"upper");
		printf("\033[0;32m客户端发送报文[%4d][%s]\033[0;37m\n",vemuSize=vemuSize/2,vemuFmlData);
		mpkgSwap(vemuFmlData,vemuTmpData);
	}
	...
	if(vemuMark=='-')
	{
		printf("\033[0;34m客户端接收报文[%4d][%s]\033[0;37m\n",vemuSize,vemuFmlData);
	}
	else
	if(vemuMark=='+')
	{
